...
def _main():
    ...
    cpp.generate_solo_navmesh(0.3, 10, obj_path, navmesh_path)
    
    # cpp.generate_tiled_navmesh(0.5, 40, obj_path, navmesh_path)
    # cpp.generate_tiled_navmesh(1, 75, obj_path, navmesh_path)
